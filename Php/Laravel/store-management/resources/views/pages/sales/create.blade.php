<form action="{{ route('sales.store')}}" method="POST" class="mt-12">
    @csrf
    ...
    <div class="group-input flex flex-col my-8">
        <label class="font-semibold text-[16px]" for="">Select Product</label>
    ...
    <div class="group-input flex flex-col my-8">
        <label class="font-semibold text-[16px]" for="">Date</label>
        <input class="h-[50px] bg-[#FAFAFB] px-6 rounded-[10px] mt-2 outline-[#605BFF]"  type="date" name="date" id="date">
    </div>
